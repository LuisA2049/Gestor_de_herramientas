...
{
    /// <summary>
    /// Interaction logic for Window_rptUsuario.xaml
    /// </summary>
    public partial class Window_rptUsuario : Window
    {
        public Window_rptUsuario()
        {
            InitializeComponent();
        }
        ...
        private void ExportarDataGridAPDF(DataGrid dataGrid)
        {
            try
            {
                ...
                if (dialogResult == true)
                {
                    ...
                    Paragraph title = new("Usuarios", font)
                    {
        ...
        private void btnImprimir_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                string comando = "SELECT tabla_usuarios.usuarios_id AS \"ID\", tabla_usuarios.usuarios_nombre AS \"Nombre\", \r\ntabla_usuarios.usuarios_tipo AS \"Tipo\", tabla_labs.lab_id AS \"Laboratorio\"\r\nFROM bd_prestamos_itspp.tabla_usuarios\r\nJOIN bd_prestamos_itspp.tabla_labs ON tabla_usuarios.lab_id = tabla_labs.lab_id;";
